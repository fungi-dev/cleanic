...
namespace Cleanic.Framework.Tests
{
    ...
    public class MongoEventStoreTests : EventStoreRequirements
    {
        ...
        {
            EventStore = new MongoEventStore("mongodb+srv://admin:ZOeEiJReeSp1V7nO@alfacontext-tests-hhe15.azure.mongodb.net/test?retryWrites=true&w=majority", NullLogger<MongoEventStore>.Instance, LanguageInfo);
        }
